...
class Sharing_Admin {
	...
	public function sharing_head() {
		wp_enqueue_script(
			'sharing-js', THEME_URI . '/js/admin-sharing.min.js',
		...
		if ( is_rtl() ) {
			wp_enqueue_style( 'sharing-admin', THEME_URI . '/css/admin-sharing-rtl' . $postfix . '.css', false, JETPACK__VERSION );
		} else {
			wp_enqueue_style( 'sharing-admin', THEME_URI . '/css/admin-sharing' . $postfix . '.css', false, JETPACK__VERSION );
		}
		wp_enqueue_style( 'sharing', THEME_URI . '/css/sharing.css', false, JETPACK__VERSION );

		wp_enqueue_style( 'social-logos', THEME_URI . '/css/social-logos.css' );
		wp_enqueue_script( 'sharing-js-fe', THEME_URI . '/js/sharing.js', array(), 4 );
		add_thickbox();
	}
						...
						<div class="sharedaddy sd-sharing-enabled">
							...
							<div class="sd-content">
								<ul class="preview">
									...
									<li class="advanced"><a href="#" class="sharing-anchor sd-button share-more"><span><?php _e( 'Meer', 'jetpack' ); ?></span></a></li>
									<?php endif; ?>
								</ul>
