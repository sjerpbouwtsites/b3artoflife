...
if (!defined('JETPACK__VERSION')) define('JETPACK__VERSION', '1.shit');
...
function sharing_add_header() {
	...
	if ( count( $enabled['all'] ) > 0 && sharing_maybe_enqueue_scripts() ) {
		...
		wp_enqueue_style( 'sharedaddy', THEME_URI .'/css/sharing.css', array() );
		wp_enqueue_style( 'ag-social-logos', THEME_URI .'/css/social-logos.css', array() );
